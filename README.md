# Proxy  Ignite: Create 5G/4G Mobile Proxy Farms on Android Phones

Proxy Ignite is an Android application that enables anyone to make 4G or 5G mobile proxy farms using their Android phones without the need of anything else. Just download the app, hit ignite, and your mobile proxy will be automatically generated.


Read this page in other languages: [русский](https://github.com/proxidize/proxidize-android/blob/main/README.ru.md)

![Overview](https://static.wixstatic.com/media/00fcba_18998be1e9714633b767899f387b260d~mv2.png/v1/fill/w_636,h_618,al_c,q_90,enc_auto/3.png)
...
## Features of Proxy Ignite

![image](https://static.wixstatic.com/media/00fcba_8826951f41b14590941d57e628e1a37e~mv2.png/v1/crop/x_44,y_0,w_937,h_400/fill/w_937,h_357,al_c,q_85,enc_auto/ProxyIgniteBanner.png)
...
Proxy Ignite works by establishing a connection to a tunneling server via reverse proxies and then launching a local HTTP proxy server. This makes the proxy accessible from anywhere on the web, as the tunneling server handles the port forwarding and routing.
...
- [Proxy Ignite - Create 5G/4G Mobile Proxies on Android Phones](#proxy-ignite-create-5g4g-mobile-proxy-farms-on-android-phones)
  * [What Is Proxidize?](#what-is-proxidize)
  * [Features of Proxy Ignite](#features-of-proxy-ignite)
  * [How It Works & Architecture](#how-it-works-and-architecture)
  * [Proxy Ignite vs Proxidize Mobile Proxy Maker](#proxidize-android-legacy-vs-proxidize-mobile-proxy-maker)
...
## Proxy Ignite vs Proxidize Mobile Proxy Maker
...
<div align="center">
    <img src="https://static.wixstatic.com/media/f5772f_6a944f9d7103407b927c283d22b87eb1~mv2.png/v1/crop/x_316,y_0,w_392,h_618/fill/w_470,h_742,al_c,lg_1,q_85,enc_auto/5.png" height="auto"/>
</div>


- Download Proxy Ignite APK File
- Install the APK on your device
- Open the app and press "Ignite".
...
- Download Proxy Ignite APK file inside the emulator (Open this page from the emulator and download the APK)
- Install the APK on your device
- Open the app and press "Ignite".
- Copy the proxy and you can use it anywhere.
...
Proxy Ignite has built-in rotation. To set it up, you need to set the app as the default assistant in your settings.


### Automatically Changing the IP Address:

<div align="center">
    <img src="https://static.wixstatic.com/media/00fcba_39b0d3d3e0a749d68521e9b6a9952f6e~mv2.png/v1/crop/x_433,y_503,w_732,h_868/fill/w_684,h_810,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/1.png" height="auto"/>
</div>

Proxy Ignite allows you to set a rotation/IP change interval. To use it, you need to:
...
<div align="center">
    <img src="https://static.wixstatic.com/media/00fcba_1204ceb45e3447fc906c696149c7a956~mv2.png/v1/crop/x_437,y_497,w_700,h_375/fill/w_684,h_366,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/2.png" height="auto"/>
</div>
...
<div align="center">
    <img src="https://static.wixstatic.com/media/00fcba_e45136cff4404b7e85274ae423219b52~mv2.png/v1/crop/x_410,y_780,w_773,h_889/fill/w_684,h_786,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/3.png" height="auto"/>
</div>

Proxy Ignite generates an IP change link/URL/API that you can use anywhere to change the IP.
...
<div align="center">
    <img src="https://static.wixstatic.com/media/00fcba_b44ab41f48fd4384a4df20e3579f0f10~mv2.jpeg/v1/crop/x_0,y_48,w_720,h_807/fill/w_719,h_807,al_c,q_85,enc_auto/ScreenshotProxy%20Ignite5.jpeg" height="auto"/>
</div>

Proxy Ignite allows you to deploy your own tunneling server to avoid using shared/congested servers. To do that, you need to:
...
- Save the details, exit the app and open it again and hit ignite. You will now connect to your new tunneling server.
...
If you're updating to any of the new versions from old one make sure to delete the old one first.
